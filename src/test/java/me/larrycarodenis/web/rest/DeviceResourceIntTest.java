...
public class DeviceResourceIntTest {
    ...
    public void createDevice() throws Exception {
        ...
        assertThat(testDevice.getPostalCode()).isEqualTo(DEFAULT_POSTAL_CODE);
    }
    ...
    public void updateDevice() throws Exception {
        ...
        assertThat(testDevice.getPostalCode()).isEqualTo(UPDATED_POSTAL_CODE);
    }
